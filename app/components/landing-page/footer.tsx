...
export const Footer = () => {
  ...
  <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© {new Date().getFullYear()} Powered by Fluxo —
      <a href="https://www.instagram.com/uselinkslie/" className="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@Linkslie</a>
    </p>
  ...
  >
    ...
    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
      <a href="https://www.instagram.com/uselinkslie/" target="_blank" className="ml-3 text-gray-500">
